...
```json
{
  ...
  "newReviewLoopContent": "## QA Complete — Awaiting Final Approval\n\nAll tests pass. The work item is ready for final human review before deployment.\n\n**To approve and close**: click Approve in the UI.\n**To request changes**: add feedback below.",
  "newTests": [
    {
